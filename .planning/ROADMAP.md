...
- [ ] 18-02-PLAN.md — lib/overpass-competencia.ts: POIs OSM con nombre/tag/coords (out center tags) para supermercado/minimarket
- [ ] 18-03-PLAN.md — lib/strip-power-centers-chile.ts: seed list geocodificada + entrada de gap en data-sources.yaml
- [ ] 18-04-PLAN.md — Geocoding on-demand de cadenas_sucursales por comuna (migración + cache-through)
