...
| Acceso comercial a TocToc (único vendor real de precios de transacción efectiva en Chile) — pendiente, no descartado | Founder (1 ago 2026): no es prioridad ahora; necesita más info (pricing, cobertura exacta) antes de comprometerse a una conversación de venta enterprise | — Pending |
