...
export const COMUNAS_CHILE: ComunaChile[] = [
  ...
  { id: 'nunoa', nombre: 'Ñuñoa', region: 'Metropolitana', provincia: 'Santiago', domStatus: 'presencial', poblacion: 'alta' },
  ...
  { id: 'puente-alto', nombre: 'Puente Alto', region: 'Metropolitana', provincia: 'Cordillera', domStatus: 'probable', poblacion: 'alta' },
