...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/mercado-inmobiliario/pricing", label: "Mercado Inmobiliario", icon: Landmark, matchPaths: ["/mercado-inmobiliario/tasacion", "/mercado-inmobiliario/noticias", "/mercado-inmobiliario/macro", "/mercado-inmobiliario/calculadora", "/mercado-inmobiliario/due-diligence"] },
    ],
  },
  {
    label: "Más",
