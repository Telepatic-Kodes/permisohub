      ...
      {expanded && (
        <div className="flex flex-col gap-2">
          {loading ? (
            ...
            <div className="flex items-center gap-2 rounded-xl border bg-card p-4 shadow-sm text-sm text-muted-foreground">
            ...
            <div className="flex flex-col gap-2">
              {observaciones.map((obs) => (
                <div key={obs.id} className="rounded-xl border bg-card p-4 shadow-sm flex flex-col gap-2">
