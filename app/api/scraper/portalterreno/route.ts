...
import { buscarTerrenos } from '@/lib/scrapers/portalterreno'
...
export async function GET(request: Request) {
  ...
  const results = await correrDescubrimientoTerrenos(COMUNAS_CON_ZONIFICACION, buscarTerrenos, workspaceId, 'portalterreno')
